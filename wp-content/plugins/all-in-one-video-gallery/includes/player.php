		...
		if ( ! empty( $params['embed_url'] ) ) {
			...
			if ( in_array( 'qualitySelector', $params['settings']['player']['controlBar']['children'] ) ) {
				wp_enqueue_style( 
					...
					AIOVG_PLUGIN_URL . 'public/assets/player/videojs-plugins/quality-selector/quality-selector.css', 
					array(), 
					'1.2.4', 
					'all' 
				);
			...
			if ( in_array( 'qualitySelector', $params['settings']['player']['controlBar']['children'] ) ) {
				wp_enqueue_script( 
					AIOVG_PLUGIN_SLUG . '-quality-selector', 
					AIOVG_PLUGIN_URL . 'public/assets/player/videojs-plugins/quality-selector/silvermine-videojs-quality-selector.min.js', 
					array(), 
					'1.2.4', 
					false 
				);
